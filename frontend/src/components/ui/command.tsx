...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'flex h-full w-full flex-col overflow-hidden rounded-lg bg-surface-1 text-fg',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-border px-3" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex h-10 w-full rounded-md bg-transparent py-2 text-sm outline-none placeholder:text-muted',
...
>((props, ref) => (
  <CommandPrimitive.Empty ref={ref} className="py-6 text-center text-xs text-muted" {...props} />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      'data-[selected=true]:bg-surface-2 data-[selected=true]:text-fg-strong',
